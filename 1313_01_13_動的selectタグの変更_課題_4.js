...
var itemList = [
    ...
    { id: '0011', name: '出刃包丁', tags: ['包丁'] },
    { id: '0012', name: '中華鍋', tags: ['鍋・プライパン'] },
];
*/
...
var itemList = [
    ...
    { id: '0002', name: 'シングルベッド', price: '10,000', tags: ['ベッド', 'ソファ', '寝具'] },
    { id: '0003', name: '子ども用ベッド', price: '5,000', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'] },
    { id: '0004', name: 'ソファ', price: '15,000', tags: ['ソファ'] },
    { id: '0005', name: 'キューブボックス', price: '8,000', tags: ['家具・ラック', '収納システム'] },
    { id: '0006', name: 'オープンラック', price: '2,000', tags: ['家具・ラック', '収納システム'] },
    { id: '0007', name: 'コンピュータデスク', price: '3,000', tags: ['テーブル・椅子'] },
    { id: '0008', name: 'サイドテーブル', price: '1000', tags: ['テーブル・椅子'] },
    { id: '0009', name: 'ダイニングテーブル', price: '1,000', tags: ['テーブル・椅子'] },
    { id: '0010', name: '子ども部屋用収納', price: '4,000', tags: ['収納システム', '子ども部屋家具'] },
    { id: '0011', name: '出刃包丁', price: '6,000', tags: ['包丁'] },
    { id: '0012', name: '中華鍋', price: '8,000', tags: ['鍋・プライパン'] },
];
...
cate1.forEach(
  value1 => {
        ...
        option.value = value1;    // optionの値に配列の値を代入
        option.text = value1;     // optionの表示文字列に配列の値を代入
...
cate2.forEach(
  value2 => {
        // option要素を新規に作成
        let option = document.createElement('option');
        option.value = value2;    // optionの値に配列の値を代入
        option.text = value2;     // optionの表示文字列に配列の値を代入
